    ...
    <div class="absolute inset-0">
      ...
      <div class="absolute inset-0">
        <div v-for="particle in backgroundParticles" :key="particle.id" 
          ...
          <Icon :name="particle.icon" class="w-6 h-6" />
        </div>
      </div>
      ...
      <div class="absolute bottom-32 right-20 w-80 h-80 bg-gradient-to-br from-green-400/10 to-cyan-400/10 rounded-full mix-blend-multiply filter blur-3xl animate-blob animation-delay-4000"></div>
      
      <!-- Grid pattern -->
      <div class="absolute inset-0 opacity-10">
        <div class="absolute inset-0" style="background-image: radial-gradient(circle at 2px 2px, rgba(59, 130, 246, 0.4) 1px, transparent 0); background-size: 50px 50px;"></div>
      </div>
    </div>
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <div class="text-center mb-20 animate-fade-in">
        ...
        <p class="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
          Ми — агенція повного циклу, що спеціалізується на моушн-дизайні, розробці, лендінгах та брендингу. 
          Використовуємо комплексні бізнес-рішення, щоб ваш бізнес досяг нових висот
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-20 items-center">
        ...
        <div class="space-y-8 animate-slide-in-left">
          <div class="space-y-6">
            ...
            <p class="text-lg text-gray-600 leading-relaxed">
              Ми адаптуємось під потреби клієнта, контролюємо всі процеси від початку до кінця. 
              У нашій команді — спеціалісти світового рівня, які забезпечують професійний супровід 
              та покривають широкий спектр сучасних технологій.
            </p>
          </div>
          ...
          <div class="grid grid-cols-2 gap-6">
            <div v-for="stat in mainStats" :key="stat.label" 
                 class="group bg-white/70 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer transform hover:-translate-y-2 border border-white/50">
          ...
          <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-200/50">
            <div class="flex items-center gap-3 mb-3">
              <div class="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center">
                <Icon name="ic:round-verified" class="w-5 h-5 text-green-600" />
              </div>
              <h4 class="font-bold text-green-800">100% Гарантія якості</h4>
            </div>
            <p class="text-green-700 text-sm">
              Кожен проект проходить багаторівневу перевірку якості. 
              Гарантуємо результат або повертаємо гроші.
            </p>
          </div>
        </div>
        ...
        <div class="relative animate-slide-in-right space-y-6">
            ...
            <div class="relative z-10">
              <div class="flex items-center gap-4 mb-4">
                <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl flex items-center justify-center shadow-md">
                  <Icon name="ic:round-auto-awesome" class="w-6 h-6 text-white" />
                </div>
                <div>
          ...
          <div class="grid grid-cols-2 gap-4">
            <div v-for="service in showcaseServices" :key="service.id"
                 class="group bg-white/80 backdrop-blur-sm rounded-xl p-4 shadow-lg hover:shadow-xl transition-all duration-300 cursor-pointer transform hover:-translate-y-1 border border-white/50">
              <div class="flex flex-col items-center text-center">
                ...
                <!-- Service stats -->
                <div class="flex items-center justify-center gap-2 mt-2 text-xs text-gray-500">
                  <Icon name="ic:round-check-circle" class="w-3 h-3 text-green-500" />
      ...
      <div class="mb-20">
        <h3 class="text-3xl font-bold text-center text-gray-900 mb-12">
          Що робить нас <span class="text-blue-600">особливими</span>
        </h3>
        
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="(feature, index) in whyChooseUs" :key="feature.id" 
               class="group bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 cursor-pointer transform hover:-translate-y-3 border border-white/50"
               :class="`animation-delay-${(index + 1) * 200}`">
            
            <!-- Hover glow effect -->
            <div class="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 rounded-2xl blur-xl"
                 :class="feature.glowColor"></div>
            ...
            <div class="relative mb-6">
              <div class="w-16 h-16 rounded-2xl flex items-center justify-center transition-all duration-500 group-hover:scale-110 group-hover:rotate-6"
                ...
                <Icon :name="feature.icon" class="w-8 h-8 transition-transform duration-500" :class="feature.iconColor" />
              </div>
              
              <!-- Floating indicator -->
              <div v-if="feature.isTop" 
            ...
            <!-- Content -->
            <h4 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r"
                :class="feature.titleGradient">
              {{ feature.title }}
            </h4>
            ...
            <ul class="space-y-2">
              <li v-for="benefit in feature.benefits" :key="benefit" 
                ...
                <Icon name="ic:round-arrow-right" class="w-4 h-4 mr-2 text-blue-500 group-hover:text-purple-500 transition-colors" />
                {{ benefit }}
              </li>
            </ul>
            ...
            <div class="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transform scale-75 group-hover:scale-100 transition-all duration-300">
              <div class="w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center">
                <Icon name="ic:round-trending-up" class="w-4 h-4 text-white" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="mb-20">
        <h3 class="text-3xl font-bold text-center text-gray-900 mb-4">
          Технології, якими ми <span class="text-purple-600">володіємо</span>
        </h3>
        ...
        <div class="flex flex-wrap justify-center items-center gap-6">
          <div v-for="(tech, index) in technologies" :key="tech.name"
               class="group bg-white/80 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg hover:shadow-xl transition-all duration-500 cursor-pointer transform hover:scale-110 border border-white/50"
               :class="`tech-item animation-delay-${index * 100}`">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-xl flex items-center justify-center"
                   :class="tech.iconBg">
                <Icon :name="tech.icon" class="w-5 h-5" :class="tech.iconColor" />
              </div>
              <span class="font-medium text-gray-900 group-hover:text-purple-600 transition-colors">{{ tech.name }}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="text-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 rounded-3xl p-12 relative overflow-hidden">
        ...
        <div class="relative">
          ...
          <p class="text-gray-600 mb-8 max-w-2xl mx-auto">
            Давайте обговоримо ваш проект і покажемо, як наша експертиза допоможе 
            вашому бізнесу досягти нових висот
          </p>
          <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <button class="px-8 py-4 border-2 border-gray-300 text-gray-700 rounded-xl font-medium hover:border-blue-500 hover:text-blue-600 transition-all duration-300 flex items-center gap-2">
              <Icon name="ic:round-visibility" class="w-5 h-5" />
...
const showcaseServices = [
  {
    id: 1,
    name: 'Веб-розробка',
    description: 'Сучасні сайти та веб-додатки',
    icon: 'ic:round-web',
    iconBg: 'bg-blue-100',
    iconColor: 'text-blue-600',
    projects: 120
  },
  {
    id: 2,
    name: 'Motion дизайн',
    description: 'Анімації та відеоконтент',
    icon: 'ic:round-movie-creation',
    iconBg: 'bg-red-100',
  ...
  },
  {
    id: 3,
    name: 'Брендинг',
    description: 'Фірмовий стиль та айдентика',
  ...
  },
  {
    id: 4,
    name: 'UX/UI дизайн',
    description: 'Інтерфейси та користувацький досвід',
...
const processSteps = [
  { title: 'Аналіз та планування', duration: '1-2 дні' },
  { title: 'Дизайн та прототипи', duration: '3-5 днів' },
  { title: 'Розробка та тестування', duration: '7-14 днів' },
  { title: 'Запуск та підтримка', duration: 'Постійно' }
];

const whyChooseUs = [
  {
    id: 1,
    title: 'Адаптуємось під потреби',
    description: 'Кожен клієнт унікальний. Ми вивчаємо ваш бізнес та створюємо персоналізовані рішення.',
    icon: 'ic:round-tune',
    iconBg: 'bg-blue-100 group-hover:bg-blue-200',
    iconColor: 'text-blue-600',
    ...
    benefits: [
      ...
      'Врахування специфіки бізнесу'
    ]
  },
  {
    id: 2,
    title: 'Контролюємо все',
    description: 'Повний контроль процесів від початку до кінця. Ви завжди в курсі стану проекту.',
    icon: 'ic:round-assignment-turned-in',
    iconBg: 'bg-green-100 group-hover:bg-green-200',
    iconColor: 'text-green-600',
  ...
  },
  {
    ...
    description: 'Досвідчені професіонали з різних галузей працюють над вашим проектом.',
    icon: 'ic:round-groups',
    iconBg: 'bg-purple-100 group-hover:bg-purple-200',
    iconColor: 'text-purple-600',
    titleGradient: 'group-hover:from-purple-500 group-hover:to-pink-600',
    glowColor: 'bg-purple-400',
    isTop: true,
    benefits: [
      'Експерти світового рівня',
      'Різнопланова експертиза',
      'Командна робота'
    ]
  },
  {
    ...
    description: 'Підтримка проекту не закінчується з його запуском — ми завжди на зв\'язку.',
    icon: 'ic:round-support-agent',
    iconBg: 'bg-orange-100 group-hover:bg-orange-200',
    iconColor: 'text-orange-600',
    titleGradient: 'group-hover:from-orange-500 group-hover:to-red-600',
    glowColor: 'bg-orange-400',
    isTop: false,
    benefits: [
      'Постійна підтримка',
      'Швидкий response час',
      'Технічне обслуговування'
    ]
  },
  {
    id: 5,
    title: 'Широкий стек технологій',
    description: 'Володіємо сучасними технологіями та постійно розширюємо свою експертизу.',
    icon: 'ic:round-code',
    iconBg: 'bg-cyan-100 group-hover:bg-cyan-200',
    iconColor: 'text-cyan-600',
    titleGradient: 'group-hover:from-cyan-500 group-hover:to-blue-600',
  ...
  },
  {
    ...
    description: 'Від стратегії до реалізації — всі послуги в одному місці для вашої зручності.',
...
const technologies = [
  { name: 'Vue.js', icon: 'ic:round-web', iconBg: 'bg-green-100', iconColor: 'text-green-600' },
  { name: 'React', icon: 'ic:round-web', iconBg: 'bg-blue-100', iconColor: 'text-blue-600' },
  { name: 'Node.js', icon: 'ic:round-dns', iconBg: 'bg-green-100', iconColor: 'text-green-600' },
  { name: 'Laravel', icon: 'ic:round-code', iconBg: 'bg-red-100', iconColor: 'text-red-600' },
  { name: 'WordPress', icon: 'ic:round-web', iconBg: 'bg-blue-100', iconColor: 'text-blue-600' },
  { name: 'Shopify', icon: 'ic:round-shopping-cart', iconBg: 'bg-green-100', iconColor: 'text-green-600' },
  { name: 'Figma', icon: 'ic:round-design-services', iconBg: 'bg-purple-100', iconColor: 'text-purple-600' },
  { name: 'After Effects', icon: 'ic:round-movie-creation', iconBg: 'bg-purple-100', iconColor: 'text-purple-600' }
];
...
@keyframes orbit-4 {
  0% { transform: translateX(-50%) rotate(180deg) translateX(120px) rotate(-180deg); }
  100% { transform: translateX(-50%) rotate(540deg) translateX(120px) rotate(-540deg); }
}
...
.animate-orbit-5 { animation: orbit-5 27s linear infinite; }
.animate-orbit-6 { animation: orbit-6 24s linear infinite; }

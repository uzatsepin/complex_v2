    ...
    <section class="py-24 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="relative mb-20">
                <!-- Timeline Line -->
                <div
                    class="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-blue-200 via-purple-200 to-pink-200 rounded-full hidden lg:block">
                ...
                <div class="space-y-16 lg:space-y-24 relative">
                    <div
                        ...
                        :key="step.id"
                        :class="['flex flex-col lg:flex-row items-center gap-8', index % 2 === 1 ? 'lg:flex-row-reverse' : '']"
                        class="animate-fade-in-up step-container"
                        :style="{ animationDelay: `${index * 0.2}s` }">
                        <!-- Step Content -->
                        <div class="flex-1 max-w-lg">
                            <div
                                class="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-500 step-card group cursor-pointer"
                                ...
                                <!-- Hover glow effect -->
                                <div
                                    class="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-500 rounded-3xl blur-xl pointer-events-none"
                        ...
                        <div class="relative z-10 hidden lg:block">
                            <div
                                class="w-20 h-20 rounded-full flex items-center justify-center shadow-xl transition-all duration-500 hover:scale-110"
                                :class="step.nodeBg">
                                <div
                        ...
                        <div class="flex-1 max-w-lg">
                            <div class="relative group">
                                <!-- Main visual -->
                                <div
                                    class="bg-gradient-to-br from-white via-gray-50 to-blue-50 rounded-3xl p-8 shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
            ...
            <div class="mb-20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    <div
                        v-for="benefit in processBenefits"
                        :key="benefit.id"
                        class="text-center group cursor-pointer transform hover:scale-105 transition-all duration-300">
                        <div
                            class="w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg transition-all duration-500 group-hover:scale-110 group-hover:rotate-6"
                            :class="benefit.iconBg">
                            <Icon
                                :name="benefit.icon"
                                class="w-8 h-8"
								size="32"
                                :class="benefit.iconColor" />
                        </div>
...
const workSteps: WorkStep[] = [
    {
        ...
        detailedDescription:
            "На цьому етапі ми проводимо глибоке дослідження вашого бізнесу, аналізуємо ринок та конкурентів. Визначаємо цільову аудиторію, її потреби та поведінку. Створюємо технічні вимоги, архітектуру проекту та детальний план реалізації.",
        duration: "3-5 днів",
    ...
    },
    {
        ...
        detailedDescription:
            "Розробляємо повний дизайн системи, від wireframes до фінального UI. Створюємо інтерактивні прототипи для тестування користувацького досвіду. Проводимо UX дослідження та A/B тестування ключових елементів.",
        duration: "1-2 тижні",
        team: "2-3 дизайнери",
    ...
    },
    {
        ...
        detailedDescription:
            "Розробляємо повнофункціональний додаток використовуючи сучасні технології. Інтегруємо з необхідними API та сервісами. Забезпечуємо високу якість коду через code review та автоматизоване тестування.",
        duration: "2-6 тижнів",
    ...
    },
    {
        ...
        detailedDescription:
            "Виконуємо комплексне тестування проекту на всіх рівнях. Тестуємо функціональність, безпеку, продуктивність та сумісність. Проводимо навантажувальні тести та оптимізуємо швидкодію.",
        duration: "1-2 тижні",
        team: "2-3 тестери",
    ...
    },
    {
        ...
        detailedDescription:
            "Здійснюємо плавний запуск проекту в production середовище. Налаштовуємо системи моніторингу, резервного копіювання та безпеки. Забезпечуємо навчання команди та постійну технічну підтримку.",

  ...
  <section class="py-20 bg-gradient-to-b from-white via-gray-50 to-white relative overflow-hidden">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <div class="text-center mb-16 animate-fade-in">
        <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 rounded-full text-sm font-medium mb-6 animate-bounce-subtle">
          <Icon name="ic:round-work" class="w-4 h-4 mr-2 text-blue-600" />
          Наші роботи
        </div>
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Кожен проект - це унікальна історія успіху. Подивіться на наші найкращі роботи 
          та переконайтеся в якості нашої експертизи
        </p>
      </div>
    ...
    <Teleport to="body">
      <div v-if="selectedProject" 
        ...
        <div class="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto animate-scale-in"
             @click.stop>
          <!-- Modal Header -->
          <div class="relative">
            ...
            <button @click="selectedProject = null"
              ...
              <Icon name="ic:round-close" class="w-5 h-5" />
            </button>
          </div>
          ...
          <div class="p-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div class="lg:col-span-2">
                ...
                <!-- Results -->
                <div v-if="selectedProject.results" class="bg-green-50 rounded-xl p-6 mb-6">
              ...
              <div class="space-y-6">
                  ...
                  <div class="space-y-4">
                    ...
                    <div class="flex justify-between">
                      ...
                      <div class="flex items-center gap-1">
                        <Icon name="ic:round-star" class="w-4 h-4 text-yellow-500" />
                ...
                <!-- Actions -->
                <div class="space-y-3">
                  <button v-if="selectedProject.liveUrl"
                    ...
                    <Icon name="ic:round-launch" class="w-5 h-5" />
                    Переглянути сайт
                  </button>
                  <button class="w-full px-6 py-3 border-2 border-gray-300 text-gray-700 rounded-xl font-medium hover:border-blue-500 hover:text-blue-600 transition-all duration-300 flex items-center justify-center gap-2">
...
const portfolioProjects: PortfolioProject[] = [
  {
    ...
    detailedDescription: 'Повнофункціональний інтернет-магазин електроніки з інтуїтивним інтерфейсом, швидким пошуком товарів, системою відгуків та рекомендацій. Інтегровані всі популярні платіжні системи України, реалізована система знижок та програма лояльності.',
    category: 'E-commerce',
  ...
  },
  {
    ...
    detailedDescription: 'Комплексна телемедична платформа, що дозволяє пацієнтам отримувати консультації лікарів онлайн. Система включає відеозв\'язок HD якості, електронні медичні картки, систему призначень та рецептів, інтеграцію з лабораторіями.',
    category: 'Healthcare',
  ...
  },
  {
    ...
    detailedDescription: 'Потужна система управління навчанням (LMS) для освітніх закладів. Включає створення інтерактивних курсів, систему тестування з різними типами питань, відеолекції, форуми для обговорень, система оцінювання та сертифікації.',
    category: 'Education',
  ...
  },
  {
    ...
    detailedDescription: 'Професійна логістична платформа для управління перевезеннями. Включає GPS-трекінг транспорту в реальному часі, оптимізацію маршрутів з урахуванням трафіку, управління документообігом, аналітику витрат палива та ефективності водіїв.',
    category: 'Web App',
  ...
  },
  {
    ...
    detailedDescription: 'Комплексне рішення для салонів краси, що включає мобільний додаток для клієнтів та адмін-панель для персоналу. Онлайн-запис на процедури, управління розкладом майстрів, програма лояльності з бонусами, push-сповіщення та SMS.',
    category: 'Mobile App',
  ...
  },
  {
    ...
    detailedDescription: 'Інтелектуальний Telegram бот для управління особистими фінансами. Автоматичне категоризування витрат, планування бюджету, аналітика трендів, нагадування про платежі, інтеграція з банківськими API для автоматичного імпорту транзакцій.',
    category: 'Web App',
  ...
  },
  {
    ...
    detailedDescription: 'Комплексний корпоративний портал для управління внутрішніми процесами великої компанії. Включає HR-модулі для управління персоналом, систему електронного документообігу, корпоративні новини, календар подій, систему заявок та багатомовність.',
    category: 'Corporate',
  ...
  },
  {
    ...
    detailedDescription: 'Повнофункціональна платформа доставки їжі, що включає мобільні додатки для клієнтів та кур\'єрів, веб-панель для ресторанів та адміністрування. GPS-трекінг замовлень в реальному часі, інтеграція платіжних систем, система рейтингів.',
    category: 'Mobile App',
  ...
  },
  {
    ...
    detailedDescription: 'Інноваційна платформа для стартапів, яка допомагає підприємцям знаходити інвесторів та представляти свої ідеї. Включає конструктор презентацій, систему матчингу стартапів та інвесторів, відеопрезентації, систему оцінювання проектів.',
    category: 'Startup',

    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <div class="text-center mb-16 animate-fade-in">
        <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 rounded-full text-sm font-medium mb-6 animate-bounce-subtle">
          <Icon name="ic:round-mail" class="w-4 h-4 mr-2 text-blue-600" />
          Залишити заявку
        </div>
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Розкажіть про свою ідею, і ми створимо для вас ідеальне цифрове рішення. 
            ...
            <div v-if="showSuccessMessage" 
              ...
              <div class="flex items-center gap-3">
                <div class="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center">
                  <Icon name="ic:round-check" class="w-4 h-4 text-green-600" />
                </div>
                <div>
              ...
              <form @submit.prevent="submitForm" class="space-y-6">
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    />
                    <Icon name="ic:round-person" class="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
                    <Icon v-if="form.name && !errors.name" name="ic:round-check" class="absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-green-500" />
                  </div>
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    />
                    <Icon name="ic:round-phone" class="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
                    <Icon v-if="form.phone && !errors.phone" name="ic:round-check" class="absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-green-500" />
                  </div>
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    />
                    <Icon name="ic:round-telegram" class="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400" />
                    <Icon v-if="form.telegram && !errors.telegram" name="ic:round-check" class="absolute right-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-green-500" />
                  </div>
                  <p v-if="errors.telegram" class="mt-1 text-sm text-red-600">{{ errors.telegram }}</p>
                </div>
                ...
                <div>
                  ...
                  <div class="relative">
                    ...
                    ></textarea>
                    <Icon name="ic:round-comment" class="absolute left-4 top-4 w-5 h-5 text-gray-400" />
                  </div>
              ...
              <div class="space-y-4">
                <div class="flex items-center gap-4">
                  <div class="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center">
                    <Icon name="ic:round-phone" class="w-6 h-6 text-blue-600" />
                  </div>
                  <div>
                ...
                <div class="flex items-center gap-4">
                  <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center">
                    <Icon name="ic:round-mail" class="w-6 h-6 text-green-600" />
                  </div>
                  <div>
                ...
                <div class="flex items-center gap-4">
                  <div class="w-12 h-12 bg-purple-100 rounded-xl flex items-center justify-center">
                    <Icon name="ic:round-telegram" class="w-6 h-6 text-purple-600" />
                  </div>
                  <div>
            ...
            <div class="relative">
              ...
              <div class="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
                <div class="flex items-center gap-2 mb-2">
                  <Icon name="ic:round-info" class="w-4 h-4 text-blue-600" />
                  <span class="text-sm font-medium text-blue-800">Швидка відповідь</span>
                </div>
                <p class="text-sm text-blue-700">
                  Відповідаємо на заявки протягом 30 хвилин у робочий час
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="mb-16">
        <h3 class="text-3xl font-bold text-center text-gray-900 mb-12">
          Часті <span class="text-blue-600">питання</span>
        </h3>

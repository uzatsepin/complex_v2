    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16 lg:h-20">
        ...
        <div class="lg:hidden">
          ...
          >
            <Icon :name="isMobileMenuOpen ? 'ic:round-close' : 'ic:round-menu'" class="w-6 h-6" />
          </button>
        </div>
      </div>
    </div>
      ...
      <div v-if="isMobileMenuOpen" class="lg:hidden border-t border-gray-100 bg-white/95 backdrop-blur-md">
        <div class="container mx-auto px-4 py-6">
          ...
          <div class="mt-6 space-y-3">
            <SecondaryButton variant="ghost" class="w-full justify-center" @click="closeMobileMenu">
              Зв'язатись
            </SecondaryButton>
            <PrimaryButton class="w-full justify-center" @click="closeMobileMenu">
              Розпочати проект
            </PrimaryButton>
          </div>
        </div>
